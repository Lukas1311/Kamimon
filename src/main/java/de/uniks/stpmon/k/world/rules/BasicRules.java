...
public class BasicRules {
    ...
    public static RuleRegistry registerRules() {
        ...
        // underpass
        registry.addConnection(new ExclusionRule(
        ...
        // house exit
        registry.addConnection(new EntangledRule(TILESET_ROOM_BUILDER,
        ...
        // house decoration
        registry.addConnection(new EntangledRule(TILESET_MODERN_INTERIORS,
        ...
        // ground path stones
        ExclusionRule pathStones = new ExclusionRule(TILESET_MODERN_EXTERIORS,
                new IdSource.Rectangle(1819, 4, 1, 176));
        registry.addConnection(pathStones);
        registry.addSingle(pathStones);
